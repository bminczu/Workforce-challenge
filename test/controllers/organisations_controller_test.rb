...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { hourly_rate: @organisation.hourly_rate, org_name: @organisation.org_name } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { hourly_rate: @organisation.hourly_rate, org_name: @organisation.org_name } }
